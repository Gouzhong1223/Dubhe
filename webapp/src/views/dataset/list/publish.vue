...
<template>
  <el-form ref="form" :model="state.model" :rules="rules" label-width="110px">
    ...
    <el-form-item label="下一版本" prop="nextVersionName">
      <el-input
        v-model="state.model.nextVersionName"
        disabled
        :autofocus="true"
      />
    </el-form-item>
    ...
    <el-form-item
      v-if="showOfRecord(row.annotateType)"
      label="转换OFRecord"
      prop="ofRecord"
    >
      <el-switch
        v-model="state.model.ofRecord"
        :active-value="1"
        :inactive-value="0"
      />
      <p style="margin: 0">
        OFRecord是凌波智能深度学习框架原生的数据格式,
        <a href="https://docs.oneflow.org/extended_topics/ofrecord.html"
          >更多参考</a
        >
      </p>
    </el-form-item>
