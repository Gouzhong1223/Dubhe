...
<template>
  <div class="optimize-record-detail">
    ...
    <div class="row">
      ...
      <div class="text">
        {{ OPTIMIZE_ALGORITHM_TYPE_MAP[record.algorithmType] || '无' }}
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="text">
        <el-button :disabled="downloadModelDisabled" @click="onDownloadModel"
          >下载</el-button
        >
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    downloadModelDisabled() {
      return (
        this.record.status !== OPTIMIZE_STATUS_ENUM.FINISHED ||
