...
<template>
  <div class="app-container">
    ...
    >
      ...
      >
        <el-form-item
          prop="notebookDelayDeleteTime"
          label="Notebook 自动关闭时间"
        >
          <el-input-number
          ...
          <el-tooltip
            effect="dark"
            content="Notebook 自动关闭时间限制为 1-24 小时"
            placement="top"
          >
        ...
        <el-form-item prop="cpuLimit" label="CPU 资源限制">
          <el-input-number
            v-model="userConfigForm.cpuLimit"
            :min="1"
            step-strictly
          />&nbsp;核
        </el-form-item>
        <el-form-item prop="gpuLimit" label="GPU 资源限制">
          <el-input-number
            v-model="userConfigForm.gpuLimit"
            :min="1"
            step-strictly
          />&nbsp;卡
        </el-form-item>
        <el-form-item prop="memoryLimit" label="内存资源限制">
          <el-input-number
            v-model="userConfigForm.memoryLimit"
            :min="1"
            step-strictly
          />&nbsp;Gi
        </el-form-item>
...
export default {
    ...
    return {
      ...
      userConfigRules: {
        notebookDelayDeleteTime: [
          {
            required: true,
            message: '请输入 Notebook 自动关闭时间',
            trigger: 'change',
          },
        ],
        cpuLimit: [
          { required: true, message: '请输入 CPU 资源限额', trigger: 'change' },
        ],
        gpuLimit: [
          { required: true, message: '请输入 GPU 资源限额', trigger: 'change' },
        ],
        memoryLimit: [
          { required: true, message: '请输入内存资源限额', trigger: 'change' },
        ],
      },
  ...
  methods: {
    ...
    [CRUD.HOOK.afterToCU]() {
      this.form.enabled =
        this.form.enabled != null ? this.form.enabled.toString() : null
      this.crud.form.roleId = this.crud.form.roles[0]?.id || ''
    },
    // 表单验证后的操作
