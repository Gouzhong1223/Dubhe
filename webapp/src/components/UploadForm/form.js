...
export default {
  ...
  methods: {
    ...
    fileChange(file, fileList) {
      ...
      const isOverSize =
        this.acceptSize !== 0 && file.size / (1024 * 1024) > this.acceptSize
    ...
    return (
      <div id="upload-form-style" class="upload-form">
        <el-upload
          ...
          multiple
          list-type={
            this.lenOfFileList > 100 || this.dataType === 'text'
              ? 'text'
              : 'picture'
          }
          auto-upload={false}
        ...
        >
          ...
          >
            <div class="upload-tip">
              ...
              {this.acceptSize > 0 && (
                <span>
                  , 单个文件不大于 {this.acceptSizeFormat(this.acceptSize)}
                </span>
              )}
            </div>
            {this.showFileCount && (
              <span class="upload-chosen-tip">
                已选择{this.lenOfFileList}个
              </span>
            )}
          </div>
        </el-upload>
